...
INSERT INTO Proyectos (nombre, id_departamento) VALUES
('Proyecto A', 1), 
('Proyecto B', 2),  
('Proyecto C', 3);  

SELECT E.nombre AS nombre_empleado, D.nombre AS nombre_departamento, P.nombre AS nombre_proyecto
FROM empleados AS E
INNER JOIN departamentos AS D 
ON E.id_departamento = D.id_departamento
INNER JOIN Proyectos AS P ON D.id_departamento = P.id_departamento;
